...
//		String url = "jdbc:jtds:sqlserver://localhost:1433/NorthwindB;useCursors=true";
	...
	public StringBuffer readDbStructure(String url, String username, String password) throws CustomSQLException {
		...
		StringBuffer resultCreateTables = new StringBuffer();
		...
		try {
			...
			while (rsTables.next()) {
				...
				//resultCreateTables.append("CREATE TABLE " + tableSchema + "." + tableName).append(" (").append(NL);
		...
		resultCreateTables.append(result);
		return titel.append(resultCreateTables);
